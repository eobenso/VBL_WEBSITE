...
const Content = () => {
    ...
    return (
        <div className='Hogan'>
            <h4 className='sub-section-name'>Community Engagement {'>'} Local Resources {'>'} Hogan's Alley Resources </h4>
            <br></br>
            <h2 className='upper heading-name'>Hogan's Alley Resources</h2>
            <br></br>
